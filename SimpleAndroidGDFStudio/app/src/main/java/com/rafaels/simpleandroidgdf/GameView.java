...
public class GameView extends SurfaceView implements Runnable{
	...
	public GameView(Context context, int gameWidth, int gameHeight) {
		...
		//Recuperamos el Surfaceholder de nuestra SurfaceView y anadimos una nueva instancia Callback
	...
	private void renderGameImage(){
		...
		if (screen != null){ 
			...
			//y usando gameImageDst para escalarla hasta el tamano disponible.
	...
	//currentState puede ahora sobreescribir onResume y onPause
